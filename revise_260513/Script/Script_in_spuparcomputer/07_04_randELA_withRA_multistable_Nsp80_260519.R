...
#n.core=8
#dir_07_02='/Users/ngch/Desktop/Now_using/data/sugaFB_ELA/revise_260513/Analysis/07_02_evaluate_multistable_dynamics'
...
#########################################################################
save.dir <- "07_04_randELA_withRA_multistable_Nsp80_260519"
dir.create(save.dir)
...
sa <- runSA(ocmat= bin,enmat = enmatf,
  ...
  saveRDS(sa, file=sprintf("%s/runSA_wo%s_%s_rand%s.rds",part,sp,cnam1,seed))
...
md_sprop <- data.frame(id=sp,
  ...
  mdp <- md_sprop
  saveRDS(mdp,sprintf("%s/ELA_SSprob_diff_ID%s_%s_rand%s.rds",part,sp,cnam1,seed))

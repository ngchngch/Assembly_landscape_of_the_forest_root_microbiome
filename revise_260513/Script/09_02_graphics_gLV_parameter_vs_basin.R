...
# load summary
############################################################
dir_09_01 <- "Analysis/09_01_gLV_parameter_vs_basin"
...
lm_strength <- lm(
  n_basin ~ mean_interaction_strength,
  data = cluster_summary
)

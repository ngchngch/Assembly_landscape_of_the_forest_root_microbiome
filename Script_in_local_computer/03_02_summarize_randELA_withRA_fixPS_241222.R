...
#########################################################################
save.dir <- "03_02_summarize_randELA_withRA_fixPS_241222"
dir.create(save.dir)
...
rand_dir <- c(list.dirs(path="03_02_randELA_withRA_4s_fixPS_1_3000_241208", recursive = FALSE),
              list.dirs(path="03_02_randELA_withRA_4s_fixPS_1_3000_241208_P", recursive = FALSE),
              list.dirs(path="03_02_randELA_withRA_4s_fixPS_6001_9000_241208", recursive = FALSE),
              list.dirs(path="03_02_randELA_withRA_4s_fixPS_6001_10500_241208_P", recursive = FALSE),
              list.dirs(path="03_02_randELA_withRA_4s_fixPS_add_241222_P", recursive = FALSE))

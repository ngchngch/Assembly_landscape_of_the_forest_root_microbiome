...
#########################################################################
save.dir <- "03_02_02_03_graphics_Zconv_ELA_withRA_4step_spatialblocking"
dir.create(save.dir)
...
z_val <- do.call(rbind,
        lapply(list.files(dir_03_02_02_02,"Zconv_ELA_results",full.names = TRUE,recursive = TRUE),
       readRDS))

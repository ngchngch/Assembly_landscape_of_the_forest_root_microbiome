...
#########################################################################
save.dir <- "02_06_07_ELA_genuslevel"
dir.create(save.dir)
...
maj_th <- 0.01
  ...
  saveRDS(sp_info[rownames(ocmatf),-c(1,ncol(sp_info))],
          file=sprintf("%s/SA_env_data_%s_%s.rds",dir,fb,taxa))
